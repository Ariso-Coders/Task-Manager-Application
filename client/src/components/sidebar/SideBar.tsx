      ...
      <div className='bg-dark_purple h-screen  pt-vh4 sm:w-vw20 w-full flex flex-col gap-vh5 items-center justify-between' >
        ...
        <div className="w-full flex flex-col items-start  ">
          ...
          <div className='w-full px-vw5'>
            ...
            <button className="text-gray-300 text-sm flex justify-start items-center gap-x-4 cursor-pointer p-5  pl-0  hover:underline rounded-sm " onClick={() => { onCallback(!logoutLogic) ;
